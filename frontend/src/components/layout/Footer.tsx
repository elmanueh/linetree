      ...
      <footer className="bg-gray-100 text-gray-700 py-10 ">
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12 text-sm">
            <div>
              ...
              <p className="text-justify">
                ...
                <strong>Trabajo de Fin de Grado</strong> en Ingeniería
                Informática por <strong>Manuel Bernabé Rodríguez</strong> en la{' '}
            ...
            <div>
              ...
              <p className="text-justify">
                ...
                refleja el esfuerzo de varios meses de investigación y
                desarrollo.
              </p>
            </div>
          ...
          <div className="mt-10 text-center text-xs text-gray-500">
            <p>
              &copy; {new Date().getFullYear()} Manuel Bernabé Rodríguez.
              Proyecto con fines académicos. Todos los derechos reservados.
            </p>
          </div>
        </div>
      </footer>
